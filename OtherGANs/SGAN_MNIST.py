...
class Generator(nn.Module):
    def __init__(self, ngpu, opChannels, activationG,same_conv_pos):
...
if __name__ == '__main__':
    ...
    activationG = [1 for x in range(nolayers - 1)]
    ...
    opFeatures = gchannels[nolayers]
    # opFeatures = [randint(64, 513) for i in range(nolayers-2)]
    # opFeatures.append(64)

    netG = Generator(ngpu,opFeatures,activationG,same_conv_pos).to(device)
    ...
    activationF = [0 for x in range(noDlayers - 1)]
    ...
    opFeatures = dchannels[noDlayers]

    print(opFeatures)

    netD = Discriminator(ngpu,opFeatures,activationF,same_conv_pos).to(device)
    ...
    for epoch in range(num_epochs):
        ...
        for i, data in enumerate(dataloader, 0):
            ...
            if (iters % 20 == 0) or ((epoch == num_epochs - 1) and (i == len(dataloader) - 1)):
                ...
                path = 'C:/Users/RACHIT/Desktop/LSGAN/mnist_dcgan/sgan/'
                size_figure_grid = 5
